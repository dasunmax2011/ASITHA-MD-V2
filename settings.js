...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=TvoTVAyQ#PeWjkRj3lKHqs1_Au2DpMUgmldaMgBmrixyORqI5ois' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello {sender} , I am alive now!!*" : process.env.ALIVE_MSG,
